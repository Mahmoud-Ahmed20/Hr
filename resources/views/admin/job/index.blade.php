                ...
                <div class="card-body">
                    ...
                    <div class="btn-popup pull-right">
                        <button type="button" class="btn btn-primary">
                            <a href="{{route('admin/job/create')}}" style="text-decoration:none;color:white;">
                                اضافه وظيفه
                            </a>
                        </button>
                    </div>
                    <div class="btn-popup pull-right mr-1">
                        <button type="button" class="btn btn-primary">
                            <a href="{{route('admin/jobs/export/excel')}}" style="text-decoration:none;color:white;">
                                <i class="fas fa-file-excel"></i>
                            </a>
                        </button>
                        <button type="button" class="btn btn-primary">
                            <a href="{{route('admin/jobs/export/pdf')}}" style="text-decoration:none;color:white;">
                    ...
                    @isset($jobs)
                        ...
                        <div class="card-body vendor-table">
                                ...
                                @foreach($jobs as $job)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <!-- activate row -->
                                                @include('admin.job.activate')
                                                <!-- end activate row -->

                                                <!-- edit row -->
                                                <button class="btn btn-warning btn-xs" type="button">
                                                    <a href="{{route('admin/jobs/edit', $job->id)}}" style="text-decoration:none;color:white;">
                            ...
                            <div style="margin-top: 20px; font-weight: 600; font-size: 16px;">
                                Showing 1 to <span id="showItems"></span> of <span>{{App\Models\Job::notArchive()->count()}}</span> entries
                            </div>
                ...
                $.ajax({
                    ...
                    success:function(data){
                        if (data.length > 0) {
                            ...
                            document.getElementById("jobRecords").style.display = null
                            document.getElementById("jobRecords").innerHTML = records
                            $('#load_more_button').remove();
                            ...
                            length = data.length
                            showItems.innerHTML = Number(length)
                            document.getElementById("jobRecords").style.display = 'none'
