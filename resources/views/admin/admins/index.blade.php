        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <ol class="breadcrumb pull-right">
                    ...
                    <li class="breadcrumb-item active">قائمه المشرفين</li>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header">
                    <h5>قائمه المشرفين</h5>
                </div>
                <div class="card-body">
                    <!-- start poper add admin -->
                        <div class="btn-popup pull-right">
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-original-title="test" data-bs-target="#exampleModal">اضافه مشرف</button>
                            <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title f-w-600" id="exampleModalLabel">اضافه مشرف</h5>
                                            ...
                                            <form class="card" action="{{url(route('admins/store'))}}" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="digital-add needs-validation">
                                                    <div class="form-group">
                                                        <label for="validationCustom01" class="col-form-label pt-0"><span>*</span> اسم المشرف</label>
                                                    ...
                                                    <div class="form-group">
                                                        <label for="validationCustom021" class="col-form-label"><span>*</span> الهاتف</label>
                                                        <input class="form-control" id="validationCustom021" name="phone" value="{{ old('phone') }}" type="number" required="">
                                                        @error('phone')
                                                        <span class="text-danger">{{$message}}</span>
                                                        @enderror
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="validationCustom022" class="col-form-label"><span>*</span> كلمه السر</label>
                                                        <input class="form-control" id="validationCustom022" name="password" type="password" required="">
                                                        @error('password')
                                                        <span class="text-danger">{{$message}}</span>
                                                        @enderror
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="validationCustom023" class="col-form-label"><span>*</span> تاكيد كلمه السر</label>
                                                        <input class="form-control" id="validationCustom023" name="password_confirmation" type="password" required="">
                                                        @error('password_confirmation')
                                                        <span class="text-danger">{{$message}}</span>
                                                        @enderror
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="validationCustom025" class="col-form-label">رفع صوره</label>
                    ...
                    <div class="btn-popup pull-right mr-1">
                        <button type="button" class="btn btn-primary">
                            <a href="{{route('admins/export/excel')}}" style="text-decoration:none;color:white;">
                                <i class="fas fa-file-excel"></i>
                            </a>
                        </button>
                        <button type="button" class="btn btn-primary">
                            <a href="{{route('admins/export/pdf')}}" style="text-decoration:none;color:white;">
                    ...
                    <div class="card-body vendor-table">
                        ...
                        <div style="margin-top: 20px; font-weight: 600; font-size: 16px;">
                            Showing 1 to <span id="showItems"></span> of <span>{{App\Models\Admin::notArchive()->count()}}</span> entries
                        </div>
                ...
                $.ajax({
                    ...
                    success:function(data){
                        if (data.length > 0) {
                            ...
                            document.getElementById("adminRecords").style.display = null
                            document.getElementById("adminRecords").innerHTML = records
                            $('#load_more_button').remove();
                            ...
                            length = data.length
                            showItems.innerHTML = Number(length)
                            document.getElementById("adminRecords").style.display = 'none'
