                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <ol class="breadcrumb pull-right">
                            ...
                            <li class="breadcrumb-item active">قائمه طلبات التوظيف</li>
                        </ol>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="btn-popup pull-right">
                                <button type="button" class="btn btn-primary">
                                    <a href="{{route('admin/employees/export/excel',$inputs)}}" style="text-decoration:none;color:white;">
                                        <i class="fas fa-file-excel"></i>
                                    </a>
                                </button>
                                <button type="button" class="btn btn-primary">
                                    <a href="{{route('admin/employees/export/pdf',$inputs)}}" style="text-decoration:none;color:white;">
                                        <i class="fas fa-file-pdf"></i>
                                    </a>
                                </button>
                            <a class="btn btn-primary" href="{{url(route('admin/employees/create'))}}">اضافه طلب توظيف</a>
                                    ...
                                    <table  class="display" id="basic-1">
                                        ...
                                        @foreach($employees as $employe)
                                            <tr>
                                                ...
                                                <td>{{$employe->position_applied_of}}</td>
                                                <td>

                                                    <button class="btn btn-primary btn-xs mt-1" type="button">
                                                        <a href="{{route('admin/employees/print', $employe->id)}}" style="text-decoration:none;color:white;">
                                                            <i class="fas fa-print"></i>
                                                        </a>
                                                    </button>
                                                    <button class="btn btn-warning mt-1 btn-xs" type="button">
                                                        <a href="{{route('admin/employees/edit', $employe->id)}}" style="text-decoration:none;color:white;">
                                                            <i class="fas fa-edit" style="color:white;"></i>
                                                        </a>
                                                    </button>
                                                    <!-- activate row -->
{{--                                                <!-- @include('admin.employees.activate') -->--}}
                                                    <!-- end activate row -->
                                    ...
                                    <div style="margin-top: 20px; font-weight: 600; font-size: 16px;">
                                        Showing 1 to <span id="showItems"></span> of <span>{{App\Models\Employe::notArchive()->count()}}</span> entries
                                    </div>
...
@section('script')
        ...
        $(document).ready(function() {
            $(document).on('click', '#load_more_button', function() {
                ...
                function load_data(id = "", _token) {
                    $.ajax({
                        url: "{{ route('admin/employees/getMore') }}",
                        method: "POST",
                        data: {
                            id: id,
                            _token: _token
                                    ...
                                    records +=
                                        `
                                                        <tr>
                                                            ...
                                                            <td>${data[i].position_applied_of}</td>
                                                            <td>
  ...
  <!-- show row -->
                                       <button class="btn btn-primary btn-xs mt-1" type="button">
                                                                ...
                                                                </button>                         <button class="btn btn-warning mt-1 btn-xs" type="button">
