...
<head>
    ...
    <!-- jsgrid css-->
    <link rel="stylesheet" type="text/css" href="{{asset('admin/assets/css/vendors/jsgrid.css')}}">
    <!-- Bootstrap css-->
                    ...
                    <div class="card tab2-card">
                        <div class="card-body">
                            <ul class="nav nav-tabs nav-material" id="top-tab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link" id="contact-top-tab" data-bs-toggle="tab" href="#top-contact" role="tab" aria-controls="top-contact" aria-selected="false"><span class="icon-unlock me-2"></span>Forget Password</a>
                                </li>
                            </ul>
                            <div class="tab-content" id="top-tabContent">
                                <div class="tab-pane fade show active" id="top-profile" role="tabpanel" aria-labelledby="top-profile-tab">
                                    <form class="auth-form" action="{{route('admin/reset-password/update')}}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <input required="" name="phone" type="number" class="form-control" placeholder="phone" id="exampleInputEmail1">
                                            @error('phone')
                                                <br>
                                        ...
                                        <div class="form-group">
                                            <input required="" name="pin_code" type="number" class="form-control" placeholder="Pin Code" id="exampleInputEmail1">
                                            @error('pin_code')
                                                <br>
                                                <span class="text-danger">{{$message}}</span>
                                            @enderror
                                        ...
                                        <div class="form-group">
                                            <input required="" name="password_confirmation" type="password" class="form-control" placeholder="Password Confirmation">
