            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <ol class="breadcrumb pull-right">
                        ...
                        <li class="breadcrumb-item active">اضافه الاجراءات الجزائيه</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="row product-adding">
                    <div class="col-xl-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form class="card" action="{{url(route('admin/penaltys/store'))}}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="outer__border">
                                            <div>
                                                ...
                                                <table>
                                                    ...
                                                    <tr>
                                                        <td><input name="joining_date" value="{{old('joining_date')}}" type="date" /></td>
                                                        <td><input name="last_penalty" value="{{old('last_penalty')}}" type="date" /></td>
                                                    </tr>
                                                </table>
                                                <table>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td><textarea name="subject" rows="10">{{old('subject')}}</textarea></td>
                                                    </tr>
                                                </table>
                                            </div>
                                        </div>
                                                    ...
                                                    <tr>
                                                        <td style="width: 50%">
                                                            <div style="margin-bottom: 8px" class="flex__td">
                                                                <span>لفت نظر</span>
                                                                <span><input name="draw_attention" value="1" type="checkbox" style="width: auto" {{old('draw_attention') ? "checked" : "" }}/></span>
                                                            ...
                                                            <div style="margin-bottom: 8px" class="flex__td">
                                                                ...
                                                                <span><input name="penalty" value="{{old('penalty')}}" type="checkbox" style="width: auto" /></span>
                                                            ...
                                                            <div style="margin-bottom: 8px" class="flex__td">
                                                                ...
                                                                <span><input name="deduction" value="{{old('deduction')}}" type="number" style="width: auto" /></span>
                                                            ...
                                                            <div style="margin-bottom: 8px" class="flex__td">
                                                                ...
                                                                <span><input name="written_warning_by_fired" value="1" type="checkbox" style="width: auto" {{old('written_warning_by_fired') ? "checked" : "" }} /></span>
                                                            ...
                                                            <div style="margin-bottom: 8px" class="flex__td">
                                                                <span>اخري</span>
                                                                <span><input name="others" value="1" type="checkbox" style="width: auto"  {{old('others') ? "checked" : "" }} /></span>
                                                                <span>Others</span><br>
                                                                @error('others')
                                                                    <span class="text-danger">{{$message}}</span>
                                                                @enderror
                                                        ...
                                                        <td style="width: 50%">
                                                            <div style="margin-bottom: 8px" class="flex__td">
                                                                ...
                                                                <span>
                                                                    <input name="stopping_from_work_for" value="{{old('stopping_from_work_for')}}" type="number" style="width: auto" />
                                                                </span>
                                                                <span>
                                                            ...
                                                            <div style="margin-bottom: 8px" class="flex__td">
                                                                ...
                                                                <span><input name="stopping_the_yearly_increase" value="1" type="checkbox" style="width: auto" {{old('stopping_the_yearly_increase') ? "checked" : "" }} /></span>
                                                            ...
                                                            <div style="margin-bottom: 8px" class="flex__td">
                                                                ...
                                                                <span><input name="firing_with_a_bying" value="1" type="checkbox" style="width: auto" {{old('firing_with_a_bying') ? "checked" : "" }}/></span>
                                                            ...
                                                            <div style="margin-bottom: 8px" class="flex__td">
                                                                ...
                                                                <span><input name="firing_without_a_bying" value="1" type="checkbox" style="width: auto" {{old('firing_without_a_bying') ? "checked" : "" }} /></span>
