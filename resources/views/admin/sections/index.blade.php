            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="btn-popup pull-right">
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-original-title="test" data-bs-target="#exampleModal">اضافه قسم</button>
                        <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title f-w-600" id="exampleModalLabel">اضافه قسم</h5>
                                        <button class="btn-close" type="button" data-bs-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                                    </div>
                                    <div class="modal-body">
                                        <form class="card" action="{{ url(route('admin/sections/store')) }}" method="post" >
                                            @csrf
                                            <div class="digital-add needs-validation">
                                                <div class="form-group">
                                                    <label for="validationCustom01" class="col-form-label pt-0"><span>*</span>  اسم قسم </label>
                                                    <input class="form-control" id="validationCustom01" name="name" value="{{ old('section') }}" type="text" required="">
                                                    @error('name')
                    ...
                    <div class="btn-popup pull-right mr-1">
                        <button type="button" class="btn btn-primary">
                            <a href="{{route('admin/sections/export/excel')}}" style="text-decoration:none;color:white;">
                                <i class="fas fa-file-excel"></i>
                            </a>
                        </button>
                        <button type="button" class="btn btn-primary">
                            <a href="{{route('admin/sections/export/pdf')}}" style="text-decoration:none;color:white;">
                    ...
                    @isset($sections)
                        ...
                        <div class="card-body vendor-table">
                                ...
                                @foreach($sections as $section)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <!-- activate row -->
                                                @include('admin.sections.activate')
                                                <!-- end activate row -->
                            ...
                            <div style="margin-top: 20px; font-weight: 600; font-size: 16px;">
                                Showing 1 to <span id="showItems"></span> of <span>{{App\Models\Section::notArchive()->count()}}</span> entries
                            </div>
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '#load_more_button', function() {
                ...
                function load_data(id = "", _token) {
                    $.ajax({
                        url: "{{ route('admin/sections/getMore') }}",
                        method: "POST",
                        data: {
                            id: id,
                            _token: _token
                        ...
                        success: function(data) {
                            if (data.length > 0) {
                                                                                ...
                                                                                <form class="card" action="${data[i].urlRouteUpdate}" method="post">
                                                                                    ...
                                                                                    <div class="digital-add needs-validation">
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <input class="form-control" id="validationCustom01" name="name" value="${data[i].name}" type="text" required="">
                                                                                            @error('name')
                                                                                            <span class="text-danger">{{$message}}</span>
                                                                                            @enderror
                                                                                        </div>
                                ...
                                document.getElementById("sectionsRecords").innerHTML += records
                                length += data.length
            ...
            $(document).on('keyup', '#data_search', function(){
                ...
                $.ajax({
                    url:"{{ route('admin/sections/search') }}",
                    method: "POST",
                    data: {
                        query: query,
                        _token: _token
                    ...
                    success:function(data){
                        if (data.length > 0) {
                            ...
                            document.getElementById("sectionsRecords").style.display = null
                            document.getElementById("sectionsRecords").innerHTML = records
                            $('#load_more_button').remove();
                            ...
                            length = data.length
                            showItems.innerHTML = Number(length)
                            document.getElementById("sectionsRecords").style.display = 'none'
