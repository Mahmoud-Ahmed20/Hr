                ...
                <div class="row product-adding">
                    <div class="col-xl-12">
                        <div class="card">
                            ...
                            @isset($evaluate)
                                <div class="card-body">
                                    <form class="card" action="{{url(route('admin/evaluatePersonalInterviews/update', $evaluate->id))}}" method="post">
                                        ...
                                        <div class="digital-add needs-validation">
                                            ...
                                            <div class="outer__border">
                                                <div>
                                                    <table>
                                                        ...
                                                        <tr>
                                                            <td><input name="name" value="{{ $evaluate->name }}" type="text"></td>
                                                            <td><input name="qualification" value="{{ $evaluate->qualification }}" type="text"></td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <select name="job_id" id="job_id">
                                                                    ...
                                                                    @foreach ($jobs as $job )
                                                                    <option  value="{{$job->id }}"{{ $evaluate->job_id == $job->id ? "selected" : "" }}>{{ $job->name_job }}</option>
                                                                    @endforeach
                                                                  </select>
                                                                  @error('job_id')
                                                            ...
                                                            <td>
                                                                <select name="section_id" id="section_id">
                                                                    ...
                                                                    <option value="{{$section->id }}"{{ $evaluate->section_id == $section->id ? "selected" : "" }}>{{ $section->name}}</option>
                                                                    @endforeach
                                                                  </select>
                                                                  @error('section_id')
                                                                <span class="text-danger">{{$message}}</span>
                                                    ...
                                                    <table>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>معرفة قدرته في اللغة الانجليزية تسمح للشركة ان تعتمد عليه في عمل البحوث او حضور اجتماعات مع
                                                                اجانب</td>
                                                            <td>10%</td>
                                                            <td><input name="english" value="{{ $evaluate->english }}" type="number"></td>
                                                        </tr>
                                                        <tr>
                                                            <td>الطموح</td>
                                                            ...
                                                            <td>5%</td>
                                                            <td><input name="ambition" value="{{ $evaluate->ambition }}" type="number"></td>
                                                        </tr>
                                                        <tr>
                                                            <td>اتخاذ القرار</td>
                                                            <td>الموظف الجيد هو الذي يتخذ القرار المناسب بحكمة وفي الوقت المناسب</td>
                                                            <td>5%</td>
                                                            <td><input name="make_decision" value="{{ $evaluate->make_decision }}" type="number"></td>
                                                        </tr>
                                                        <tr>
                                                            <td>الخبرة</td>
                                                            <td>الخبرات السابقة تعطيك تصور عن الاشياء التي قام بها من قبل وهل هي متوافقة مع الوظيفة المطروحة ام
                                                                لا</td>
                                                            <td>15%</td>
                                                            <td><input name="experience" value="{{ $evaluate->experience }}" type="number"></td>
                                                        </tr>
                                                        <tr>
                                                            <td>المهارات</td>
                                                            <td>تعرف ما هي قدراته مثل السرعة وحب التعلم والنشطا وما هو الذي تميزه عن غيره؟ وهل هي متوافقة مع الوظيفة المطروحة ام لا</td>
                                                            <td>20%</td>
                                                            <td><input name="skills" value="{{ $evaluate->skills }}" type="number"></td>
                                                        </tr>
                                                        <tr>
                                                            <td>المؤهل العلمي</td>
                                                            <td>هل الشهادرة متوافقة مع الوظيفة المتاحة ام لا</td>
                                                            <td>10%</td>
                                                            <td><input name="qualification_skills" value="{{ $evaluate->qualification_skills }}" type="number"></td>
                                                        </tr>
                                                        <tr>
                                            ...
                                            <div style="margin-bottom: 15px;">
                                                <h3>ملاحظات</h3>
                                                <textarea style="width: 100%;" rows="5" name="notes">{{ $evaluate->notes }}</textarea>
                                            </div>

                                            <div style="display: flex; margin-bottom: 15px;">
                                                <div>
                                                    <input type="radio" name="interview_status" value="قبول" {{ $evaluate->interview_status == "قبول" ? "checked" : "" }}>
                                                    <label for="">قبول</label>
                                                </div>
                                                <div style="margin: 0 10px;">
                                                    <input type="radio" name="interview_status" value="انتظار" {{ $evaluate->interview_status == "انتظار" ? "checked" : "" }}>
                                                    <label for="">انتظار</label>
                                                </div>
                                                <div>
                                                    <input type="radio" name="interview_status" value="رفض" {{ $evaluate->interview_status == "رفض" ? "checked" : "" }}>
                                                    <label for="">رفض</label>
                                                </div>
                                            </div>
                                            ...
                                            <div style="display: flex;">
                                                <div>
                                                    ...
                                                    <input name="interview_date" value="{{ $evaluate->interview_date }}" type="date">
                                                </div>
                                            </div>
