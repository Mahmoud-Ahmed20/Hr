                ...
                <div class="col-lg-6">
                    <ol class="breadcrumb pull-right">
                        ...
                        <li class="breadcrumb-item active">
                            <a style="text-decoration:none;color:black;" href="{{url(route('admin/staffs/index'))}}">قائمة الموظفين</a>
                        </li>
                        <li class="breadcrumb-item active">طباعه نوذج</li>
                    </ol>
                </div>
            </div>
        </div>
                                    ...
                                    <div>
                                            ...
                                            <tr>
                                                <td colspan="2">
                                                    <div class="flex__td">
                                                        ...
                                                        <span>
                                                            <span>لا <input disabled name="have_you_any_dependents" value="0" type="radio" style="margin: 0 5px; width: auto;" {{ $staff->have_you_any_dependents == 0 ? 'checked' : '' }}> No</span> <br>
                                                            <span>
                                                                نعم
                                            ...
                                            <tr>
                                                <td>
                                                    <div style="margin-bottom: 5px">
                                                        <input disabled name="phone" value="{{ optional($staff->lastJob)->phone }}" type="number" placeholder="الهاتف"/>
                                                        @error('phone')
                                                            <span class="text-danger">{{$message}}</span>
                                                        @enderror
                                                    </div>
                                        ...
                                        <table>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div style="margin-bottom: 5px">
                                                        <input disabled name="country" value="{{ optional($staff->qualification)->country }}" type="text" placeholder="البلد"/>
                                                        @error('country')
                                                            <span class="text-danger">{{$message}}</span>
                                                        @enderror
                                                    </div>
                                                    <div>
                                                        <input disabled name="city" value="{{ optional($staff->qualification)->city }}" type="text" placeholder="المدينة"/>
                                                        @error('city')
                                                            <span class="text-danger">{{$message}}</span>
                                                        @enderror
                                                    </div>
