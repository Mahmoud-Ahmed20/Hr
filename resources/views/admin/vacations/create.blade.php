                ...
                <div class="row product-adding">
                    <div class="col-xl-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form class="card" action="{{url(route('admin/vacations/store'))}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="digital-add needs-validation modal__body" style="direction:rtl;">
                                        <header>
                                            ...
                                            <div class="flex__td">
                                                <span>
                                                    التاريخ 
                                                    <input class="form-control" name="request_date" value="{{ old('request_date') }}" type="date" style="width: auto" />
                                                    @error('request_date')
                                            ...
                                            <div class="flex__td">
                                                <span class="flex__td" style="width: 48%">
                                                    ...
                                                    <select name="staff_id" id="staff_id" class="form-control">
                                                        <option  selected  disabled>-- يرجي تحديد الموظف  ----</option>
                                                    </select>
                                                    @error('staff_id')
                                                        <span class="text-danger">{{$message}}</span>
                                                    @enderror
                                                ...
                                                <span class="flex__td" style="width: 48%">
                                                    الرقم الوظيفي 
                                                    <input class="form-control" name="job_number" value="{{ old('job_number') }}" type="text" style="width: 85%"/>
                                                    @error('job_number')
                                                        <span class="text-danger">{{$message}}</span>
                                                    @enderror
                                                </span>
                                            ...
                                            <div class="flex__td">
                                                <span class="flex__td" style="width: 48%" >
                                                    المسمي الوظيفي
                                                    <input class="form-control" name="job_title" value="{{ old('job_title') }}" type="text" style="width: 85%"/>
                                                    @error('job_title')
                                                        <span class="text-danger">{{$message}}</span>
                                                    @enderror
                                                </span>
                                                    ...
                                                    <tr>
                                                        <td style="border-right: 0; border-left: 0">
                                                            <div class="flex__td">
                                                                ...
                                                                <span>
                                                                    اول يوم من الاجازة
                                                                    <input class="form-control" name="first_day_off" value="{{ old('first_day_off') }}" type="date" style="width: auto" />
                                                                    @error('first_day_off')
                                                                        <span class="text-danger">{{$message}}</span>
                                                                    @enderror
                                                                </span>
                                                                <span>
                                                                    اخر يوم من الاجازة
                                                                    <input class="form-control" name="last_date_off" value="{{ old('last_date_off') }}" type="date" style="width: auto"/>
                                                                    @error('last_date_off')
                                                                        <span class="text-danger">{{$message}}</span>
                                                                    @enderror
                                                                </span>
                                                                <span>
                                                                    عدد الايام 
                                                                    <input class="form-control" name="all_days" value="{{ old('all_days') }}" type="text" style="width: auto"/>
                                                                </span>
                                                            </div>
                                                            <div>
                                                                <span>
                                                                    العنوان اثناء الاجازة
                                                                    <input class="form-control" name="address_in_vacation" value="{{ old('address_in_vacation') }}" type="text" style="width: 90%"/>
                                                        ...
                                                        <td>
                                                            <div class="flex__td">
                                                                ...
                                                                <span style="width: 75%; text-align: center">
                                                                    <input class="form-control" name="exit_and_return_visa" value="{{ old('exit_and_return_visa') }}" type="text"/>
                                                            ...
                                                            <div class="flex__td">
                                                                ...
                                                                <span style="width: 75%; text-align: center">
                                                                    <input class="form-control" name="country_visa" value="{{ old('country_visa') }}" type="text"/>
                                                                    @error('country_visa')
                                                                        <span class="text-danger">{{$message}}</span>
                                                                    @enderror
                                                                </span>
                                                            ...
                                                            <div class="flex__td">
                                                                ...
                                                                <span style="width: 75%; text-align: center">
                                                                    <input class="form-control" name="ticket_reservation" value="{{ old('ticket_reservation') }}" type="text"/>
                                                            ...
                                                            <div class="flex__td">
                                                                ...
                                                                <span style="width: 75%; text-align: center">
                                                                    <input class="form-control" name="ticket_reimbursement" value="{{ old('ticket_reimbursement') }}" type="text"/>
                                                            ...
                                                            <div class="flex__td">
                                                                <div style="width: 30%">
                                                                    ...
                                                                    <span>
                                                                        <input class="form-control" name="date_travel" value="{{ old('date_travel') }}" type="date" style="width: auto" />
                                                                        @error('date_travel')
                                                                            <span class="text-danger">{{$message}}</span>
                                                                        @enderror
                                                                    </span>
                                                                ...
                                                                <div style="width: 30%">
                                                                    ...
                                                                    <span>
                                                                        <input class="form-control" name="air_line" value="{{ old('air_line') }}" type="text" style="width: auto" />
                                                                        @error('air_line')
                                                                            <span class="text-danger">{{$message}}</span>
                                                                        @enderror
                                                                    </span>
                                                                ...
                                                                <div style="width: 30%">
                                                                    <span>الخط</span>
                                                                    <span>
                                                                        <input class="form-control" name="line" value="{{ old('line') }}" type="text" style="width: auto" />
                                                                        @error('line')
                                                                            <span class="text-danger">{{$message}}</span>
                                                                        @enderror
                                                                    </span>
                                                            ...
                                                            <div class="flex__td">
                                                                <div style="text-align: center; width: 30%">
                                                                    <div class="flex__td">
                                                                        <span>اطفال</span>
                                                                        <span style="width: 85%">
                                                                            1- <input class="form-control" name="persons[3][name]" value="{{ old('persons.3.name') }}" style="width: 90%" type="text"/>
                                                                ...
                                                                <div style="text-align: center; width: 30%">
                                                                    <div class="flex__td">
                                                                        <span>&nbsp;</span>
                                                                        <span style="width: 85%">
                                                                            2- <input class="form-control" name="persons[4][name]" value="{{ old('persons.4.name') }}" style="width: 90%" type="text"/>
                                                                            <input name="persons[4][person_id]" value="3" type="hidden" />
                                                                        </span>
                                                                    </div>
                                                                </div>
                                                                <div style="text-align: center; width: 15%">
                                                            ...
                                                            <div class="flex__td">
                                                                <div style="text-align: center; width: 30%">
                                                                    <div class="flex__td">
                                                                        <span>&nbsp;</span>
                                                                        <span style="width: 85%">
                                                                            3- <input class="form-control" name="persons[5][name]" value="{{ old('persons.5.name') }}" style="width: 90%" type="text"/>
                                                                            <input name="persons[5][person_id]" value="3" type="hidden" />
                                                                        </span>
                                                                    </div>
                                                                </div>
                                                                <div style="text-align: center; width: 15%">
                                                                ...
                                                                <div style="text-align: center; width: 30%">
                                                                    <div class="flex__td">
                                                                        <span>&nbsp;</span>
                                                                        <span style="width: 85%">
                                                                            4- <input class="form-control" name="persons[6][name]" value="{{ old('persons.6.name') }}" style="width: 90%" type="text"/>
                                                                            <input name="persons[6][person_id]" value="3" type="hidden" />
                                                                        </span>
                                                                    </div>
                                                                </div>
                                                                <div style="text-align: center; width: 15%">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="flex__td">
                                                                <span>ملاحظات</span>
                                                                <span style="width: 95%">
                                                                    <input class="form-control" name="notes_one" value="{{ old('notes_one') }}" style="width: 99%" type="text"/>
                                                                </span>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                ...
                                                <table>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <div class="flex__td">
                                                            ...
                                                            <span style="width: 50%">
                                                                <input class="form-control" name="previous_return_date" value="{{ old('previous_return_date') }}" type="date" />
                                                        ...
                                                        <div class="flex__td">
                                                            ...
                                                            <span>
                                                                <input class="form-control" name="paid_leave" value="{{ old('paid_leave') }}" type="number" />
                                                                @error('paid_leave')
                                                                    <span class="text-danger">{{$message}}</span>
                                                                @enderror
                                                            </span>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <div class="flex__td">
                                                            ...
                                                            <span>
                                                                <input class="form-control" name="unpaid_leave_per_year" value="{{ old('unpaid_leave_per_year') }}" type="number" />
                                                        ...
                                                        <div class="flex__td">
                                                            ...
                                                            <span>
                                                                <input class="form-control" name="unpaid_leave" value="{{ old('unpaid_leave') }}" type="number" />
                                                                @error('unpaid_leave')
                                                                    <span class="text-danger">{{ $message }}</span>
                                                                @enderror
                                                            </span>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="flex__td">
                                                                ...
                                                                <span>
                                                                    <input class="form-control" name="holidays" value="{{ old('holidays') }}" type="number" />
                                                                    @error('holidays')
                                                                        <span class="text-danger">{{$message}}</span>
                                                                    @enderror
                                                                </span>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="flex__td">
                                                                ...
                                                                <span>
                                                                    نعم 
                                                                    <input name="is_the_passport_valid" value="1" type="radio" style="width: auto" {{ old('is_the_passport_valid') == 1 ? "checked" : "" }}/>
                                                                </span>
                                                                <span>
                                                                    لا 
                                                                    <input name="is_the_passport_valid" value="0" type="radio" style="width: auto" {{ old('is_the_passport_valid') == 0 ? "checked" : "" }}/>
                                                                </span>
                                                        ...
                                                        <td>
                                                            <div class="flex__td">
                                                                ...
                                                                <span>
                                                                    نعم 
                                                                    <input name="cover_the_duration_of_the_visa" value="1" type="radio" style="width: auto" {{ old('cover_the_duration_of_the_visa') == 1 ? "checked" : "" }}/>
                                                                </span>
                                                                <span>
                                                                    لا 
                                                                    <input name="cover_the_duration_of_the_visa" value="0" type="radio" style="width: auto" {{ old('cover_the_duration_of_the_visa') == 0 ? "checked" : "" }}/>
                                                                </span>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="flex__td">
                                                                ...
                                                                <span>
                                                                    نعم 
                                                                    <input name="is_the_residence_permit_valid" value="1" type="radio" style="width: auto" {{ old('is_the_residence_permit_valid') == 1 ? "checked" : "" }}/>
                                                                </span>
                                                                <span>
                                                                    لا 
                                                                    <input name="is_the_residence_permit_valid" value="0" type="radio" style="width: auto" {{ old('is_the_residence_permit_valid') == 0 ? "checked" : "" }}/>
                                                                </span>
