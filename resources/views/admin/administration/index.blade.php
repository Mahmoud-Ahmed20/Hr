            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="btn-popup pull-right">
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-original-title="test" data-bs-target="#exampleModal">اضافه ادارة</button>
                        <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title f-w-600" id="exampleModalLabel">اضافه ادارة</h5>
                    ...
                    <div class="btn-popup pull-right mr-1">
                        <button type="button" class="btn btn-primary">
                            <a href="{{route('admin/administration/export/excel')}}" style="text-decoration:none;color:white;">
                                <i class="fas fa-file-excel"></i>
                            </a>
                        </button>
                        <button type="button" class="btn btn-primary">
                            <a href="{{route('admin/administration/export/pdf')}}" style="text-decoration:none;color:white;">
                    ...
                    @isset($administrations)
                        ...
                        <div class="card-body vendor-table">
                            <table  class="display" id="basic-1">
                                ...
                                <tbody id="administrationRecords">
                                @foreach($administrations as $administration)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <!-- activate row -->
                                                @include('admin.administration.activate')
                                                <!-- end activate row -->

                                                  <!-- edit row -->
                                                  @include('admin.administration.edit')
                                                  <!-- end edit row -->
                                                <!-- delete row -->
                                                @include('admin.administration.delete')
                                                <!-- end delete row -->
                            ...
                            <div style="margin-top: 20px; font-weight: 600; font-size: 16px;">
                                Showing 1 to <span id="showItems"></span> of <span>{{App\Models\Administration::notArchive()->count()}}</span> entries
                            </div>
...
@section('script')
    <script>
        let dataLen = @json($administrations);
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '#load_more_button', function() {
                ...
                function load_data(id = "", _token) {
                    $.ajax({
                        url: "{{ route('admin/administration/getMore') }}",
                        method: "POST",
                        data: {
                            id: id,
                            _token: _token
                            ...
                            if (data.length > 0) {
                                for (let i = 0; i < data.length; i++) {
                                    ...
                                    records +=
                                                `
                                                    <tr>
                                                        <td>${data[i].name_administration}</td>
                                                        <td>
                                                            <!-- activate row -->
                                                                            ...
                                                                            <div class="modal-body mt-3">
                                                                                <form class="card" action="${data[i].urlRouteUpdate}" method="post">
                                                                                    ...
                                                                                    <div class="digital-add needs-validation">
                                                                                        <div class="form-group">
                                                                                            <label for="validationCustom01" class="col-form-label pt-0"><span>*</span>  اسم الادارة </label>
                                                                                            <input class="form-control" id="validationCustom01" name="name_administration" value="${data[i].name_administration}" type="text" required="">
                                                                                            @error('car_type')
                                                                                            <span class="text-danger">{{$message}}</span>
                                                                                            @enderror
                                                                                        </div>
                                ...
                                document.getElementById("administrationRecords").innerHTML += records
                                length += data.length
            ...
            $(document).on('keyup', '#data_search', function(){
                ...
                $.ajax({
                    url:"{{ route('admin/administration/search') }}",
                    method: "POST",
                    data: {
                        query: query,
                        _token: _token
                    ...
                    success:function(data){
                        if (data.length > 0) {
                            ...
                            document.getElementById("administrationRecords").style.display = null
                            document.getElementById("administrationRecords").innerHTML = records
                            $('#load_more_button').remove();
                            ...
                            length = data.length
                            showItems.innerHTML = Number(length)
                            document.getElementById("administrationRecords").style.display = 'none'
                            let btnNoData = `<button type="button" name="load_more_button" class="w-auto btn btn-primary form-control px-5" id="load_more_button_remove">Not Found Data</button>`
                            document.getElementById("load_more").innerHTML = btnNoData
                        }
                    }
